...
public class BoardView {
    ...
    public BoardView(JFrame mainFrame, JPanel mainPanel, JPanel sPanel, ArrayList<Square> squareList, int rightSquares){
        ...
        BoardController controller = new BoardController(rightSquares, mainFrame, mainPanel);
    }
    ...
    public JButton createButton(){
        ...
        ButtonFunctionality functionality = new ButtonFunctionality(button, mainFrame, squareCollection, controller);
